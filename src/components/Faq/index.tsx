      ...
      <div className="container">
        ...
        <div className="-mx-4 mt-[60px] flex flex-wrap lg:mt-20">
          <div className="w-full px-4 lg:w-1/2">
            <SingleFaq
              question="What do prices look like?"
          ...
          <div className="w-full px-4 lg:w-1/2">
            ...
            />
            <SingleFaq
              question="Where do I take my dogs?"
              answer="Our training services occur at <ADDRESS HERE>"
            />
            <SingleFaq
              question="Why should I take my dogs here?"
              answer="We treat your dogs with upmost care. We are the best in the business."
            />
          </div>
        </div>
      </div>
