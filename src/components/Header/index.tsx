...
const Header = () => {
  ...
  const handleLanguageChange = (locale: string) => (e: MouseEvent<HTMLAnchorElement>) => {
        ...
        <div className="container">
          <div className="relative -mx-4 flex items-center justify-between">
            <div className="w-60 max-w-full px-4">
              ...
              >
                {pathUrl !== "/" ? (
                  <>
                    <Image
                      src={`/images/logo/lalomalogo.png`}
                      alt="logo"
                      width={140}
                      height={30}
                    ...
                    />
                    <Image
                      src={`/images/logo/lalomalogo-white.png`}
                      alt="logo"
                      width={140}
                      height={30}
                  ...
                  <>
                    <Image
                      src={`${
                        sticky
                          ? "/images/logo/lalomalogo.png"
                          : "/images/logo/lalomalogo-white.png"
                      }`}
                      alt="logo"
                      width={140}
                      height={30}
            ...
            <div className="flex w-full items-center justify-between px-4">
                          ...
                          >
                            {menuItem.submenu.map((submenuItem: any) => (
                              ...
                              <Link
                                ...
                                onClick={handleLanguageChange(submenuItem.locale)}
                                className={`block rounded px-4 py-[10px] text-sm ${
                                  pathUrl === submenuItem.path
                                    ? "text-primary"
                                    : "text-body-color hover:text-primary dark:text-dark-6 dark:hover:text-primary"
              ...
              {/* <Link href='/about' locale='es'>test</Link> */}
